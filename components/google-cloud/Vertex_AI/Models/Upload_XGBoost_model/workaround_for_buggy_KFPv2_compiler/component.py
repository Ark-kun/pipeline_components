...
if __name__ == "__main__":
    ...
    upload_XGBoost_model_to_Google_Cloud_Vertex_AI_op = create_component_from_func(
        ...
        annotations={
            ...
            "canonical_location": "https://raw.githubusercontent.com/Ark-kun/pipeline_components/KFPv2_hell/components/google-cloud/Vertex_AI/Models/Upload_XGBoost_model/workaround_for_buggy_KFPv2_compiler/component.yaml",
        },
