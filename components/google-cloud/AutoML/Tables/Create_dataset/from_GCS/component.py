...
def create_dataset_from_GCS_for_Google_Cloud_AutoML_Tables(
    data_uri: 'GoogleCloudStorageUri',
...
if __name__ == '__main__':
    create_dataset_from_GCS_for_Google_Cloud_AutoML_Tables_op = create_component_from_func(
        create_dataset_from_GCS_for_Google_Cloud_AutoML_Tables,
        base_image='python:3.9',
        packages_to_install=['google-cloud-automl==2.4.2'],
        output_component_file='component.yaml',
        annotations={
            "author": "Alexey Volkov <alexey.volkov@ark-kun.com>",
            "canonical_location": "https://raw.githubusercontent.com/Ark-kun/pipeline_components/master/components/google-cloud/AutoML/Tables/Create_dataset/from_GCS/component.yaml",
        },
    )
