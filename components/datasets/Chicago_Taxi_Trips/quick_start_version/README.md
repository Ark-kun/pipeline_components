...
Location: [GitHub](https://github.com/Ark-kun/pipeline_components/blob/master/components/datasets/Chicago_Taxi_Trips/quick_start_version/component.yaml), [Raw](https://raw.githubusercontent.com/Ark-kun/pipeline_components/master/components/datasets/Chicago_Taxi_Trips/quick_start_version/component.yaml)
...
|**Select** **\***|[String]|tips,trip_seconds,trip_miles,pickup_community_area,dropoff_community_area,fare,tolls,extras,trip_total||
...
```python
chicago_Taxi_Trips_dataset_op = components.load_component_from_url("https://raw.githubusercontent.com/Ark-kun/pipeline_components/master/components/datasets/Chicago_Taxi_Trips/quick_start_version/component.yaml")
...
