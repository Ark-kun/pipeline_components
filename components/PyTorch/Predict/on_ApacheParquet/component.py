...
def predict_with_PyTorch_model_on_ApacheParquet_data(
...
if __name__ == "__main__":
    predict_with_PyTorch_model_on_ApacheParquet_data_op = create_component_from_func(
        predict_with_PyTorch_model_on_ApacheParquet_data,
