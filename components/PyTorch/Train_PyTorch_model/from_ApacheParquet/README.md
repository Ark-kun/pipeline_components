...
# Train pytorch model from ApacheParquet
...
```python
train_pytorch_model_from_ApacheParquet_op = components.load_component_from_url("https://raw.githubusercontent.com/Ark-kun/pipeline_components/master/components/PyTorch/Train_PyTorch_model/from_CSV/component.yaml")
...
train_pytorch_model_from_ApacheParquet_task = train_pytorch_model_from_ApacheParquet_op(
    model=...,
    training_data=...,
    label_column_name=...,
    # Optional:
